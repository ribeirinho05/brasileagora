"""
BRASIL AGORA — Clima em Tempo Real
Busca dados climáticos via OpenWeatherMap para Brasília-DF
"""

import logging
from http_utils import requisicao_com_retry

logger = logging.getLogger('brasileagora.clima')
...
def buscar_clima():
    ...
    try:
        ...
        logger.info(f"Clima Brasília: {temp}°C, {descricao_pt}")
        return clima
...
def _clima_fallback():
    return {
        ...
        'temperatura': 25, 'temp_min': 18, 'temp_max': 30,
        'umidade': 50, 'condicao': 'Parcialmente Nublado',
        'icone': 'partly_cloudy_day', 'vento': 10.0,
    }
